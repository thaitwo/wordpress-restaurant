...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
    ...
    <div class="entry-content">
        ...
        <p>
            <?php
            if (wp_is_mobile()) { ?>
                <script type='text/javascript' src='//www.opentable.com/widget/reservation/loader?rid=<?php echo the_field('ot_restaurant_id') ?>&domain=com&type=standard&theme=tall&lang=en&overlay=false&iframe=false'></script>
            <?php
            } else { ?>
