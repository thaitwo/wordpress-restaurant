        ...
        <article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
            ...
            if( have_rows('menu_section') ):
                ...
                while( have_rows('menu_section') ) : the_row();
                    ...
                    <?php
                    if ($section_image): ?>
                        <div class="section-divider full l-flex is-hori align-vert-center" style="background: linear-gradient(rgba(0, 0, 0, 0.6), rgba(0, 0, 0, 0.6)), url( <?php echo $section_image; ?>) fixed; background-size: cover;">
                    ...
                    <div class="main-page">
                        <div class="menu-section-content l-flex is-hori align-hori-space-between flex-wrap">
