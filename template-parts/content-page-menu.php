        ...
        <div class="main-page">
            <div id="content" class="site-content inner">
                ...
                <article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
                    ...
                    <div class="entry-content l-flex is-hori">
                        <div>
                            <h1 class="menu-category">
                                <?php
                                    $menu_category = get_field('menu_category_left');
                                    echo $menu_category;
                                ?>
                            </h1>
                            <p class="menu-item">
                                <?php
                                    $menu_item = get_field('menu_item_left');
                                    echo $menu_item;
                                ?>
                            </p>
                            <p class="menu-item-description">
                                <?php
                                    $menu_item_description = get_field('menu_item_description_left');
                                    echo $menu_item_description;
                                ?>
                            </p>
                        </div>
                        ...
                        <div>
                            <h1 class="menu-category">
                                <?php
                                    $menu_category = get_field('menu_category_r');
                                    echo $menu_category;
                                ?>
                            </h1>
                            <p class="menu-item">
                                <?php
                                    $menu_item = get_field('menu_item_r');
                                    echo $menu_item;
                                ?>
                            </p>
                            <p class="menu-item-description">
                                <?php
                                    $menu_item_description = get_field('menu_item_description_r');
                                    echo $menu_item_description;
                                ?>
                            </p>
                        </div>
